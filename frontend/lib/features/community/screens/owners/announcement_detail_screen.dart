...
/// Owner-side counterpart to
/// ../member/announcement_detail_screen.dart — same layout (AccentCard
/// header, like button, inline CommentsSection), reusing the exact same
/// widgets rather than re-deriving them. The two differences: an Edit
/// action in the app bar (staff-only — AnnouncementEditScreen already
/// assumes a staff caller), and CommentsSection's own [Comment.canDelete]
/// naturally grants a delete icon on any comment here once the caller
/// is staff, with no extra wiring needed on this screen's part.
...
class _AnnouncementDetailScreenState
  ...
  Future<void> _openEdit() async {
    final changed = await Navigator.of(context).push<bool>(
      MaterialPageRoute(
        builder: (_) => AnnouncementEditScreen(announcement: _announcement),
      ),
    );
